...
export async function callUpdate(callUpdate) {
    ...
    let vcard = `BEGIN:VCARD\nVERSION:3.0\nN:;⫷᭄©DROID-8-MD﹏✍;;;\nFN:⫷᭄©DROID-8-MD﹏✍\nORG:⫷᭄©DROID-8-MD﹏✍\nTITLE:\nitem1.TEL;waid=50258487658:+521 241 237 7467\nitem1.X-ABLabel:⫷᭄©DROID-8-MD﹏✍\nX-WA-BIZ-DESCRIPTION:[❗] ᴄᴏɴᴛᴀᴄᴛᴀ ᴀ ᴇsᴛᴇ ɴᴜᴍ ᴘᴀʀᴀ ᴄᴏsᴀs ɪᴍᴘᴏʀᴛᴀɴᴛᴇs.\nX-WA-BIZ-NAME:⫷᭄©DROID-8-MD﹏✍\nEND:VCARD`
    await this.sendMessage(nk.from, { contacts: { displayName: '⫷᭄©TONY-OFC﹏✍', contacts: [{ vcard }] }}, {quoted: callmsg})
...
global.dfail = (type, m, conn) => {
    ...
    let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: msg, contextInfo: { externalAdReply: { title: '[ ⚠ ] 𝐀𝐕𝐈𝐒𝐎 - 𝐀𝐋𝐄𝐑𝐓𝐀', body: '⫷᭄©DROID-8-MD﹏✍', thumbnail: imagen1, sourceUrl: 'https://chat.whatsapp.com/CkA0gnGz99l6fJgTbIvUBH' }}}}, aa)
